...
public class c5_CreatingSequence {
  ...
  public void value_I_already_have_mono() {
    ...
    Mono<String> valueIAlreadyHaveMono = null;
  ...
  public void callable_counter() {
    ...
    //todo: change this line only
    Mono<Integer> callableCounterMono = null;
  ...
  public void future_counter() {
    ...
    //todo: change this line only
    Mono<Integer> futureCounterMono = null;
  ...
  public void runnable_counter() {
    ...
    //todo: change this line only
    Mono<Integer> runnableMono = null;
  ...
  public void multi_threaded_producer() {
    ...
    StepVerifier.create(producer.doOnNext(System.out::println).take(100)).expectNextCount(100).verifyComplete();
  }
}
